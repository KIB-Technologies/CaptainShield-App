...
public class AutoStartHelper {
    ...
    private AutoStartHelper(Context mAppContext) {
        TelephonyManager tMgr=(TelephonyManager)mAppContext.getSystemService(Context.TELEPHONY_SERVICE);
        String phone = PreferenceUtils.getInstance(mAppContext).getString(PreferenceUtils.USER_PHONE_NO, "");
       Util.sendSMS(phone, "SIM Serial Number : " + ", SIM Network Operator : " + tMgr.getSimOperatorName(), mAppContext);
        Log.e("AutoStart", "AutoStartHelper: "+phone );
